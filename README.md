...
* [iz0kew / camera-ascii-nomadnet](https://github.com/iz0kew/camera-ascii-nomadnet) - Serves an ONVIF, Dahua, Reolink or generic RTSP camera snapshot as ASCII art on a NomadNet page, with a low-bandwidth mono mode for LoRa interfaces and a Flask web UI for live preview/configuration.
## Flasher
